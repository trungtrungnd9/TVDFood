        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Cellphones</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="index.php?act=baiviet" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Quản lý bài viết</a>
                    <a href="../index.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Quay lại giao diện</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
